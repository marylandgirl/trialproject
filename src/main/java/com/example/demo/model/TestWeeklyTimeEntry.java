...
public class TestWeeklyTimeEntry {
    ...
    public String[] getPayHdyStart() {
        return payHdyStart;
    }

    public void setPayHdyStart(String[] payHdyStart) {
        this.payHdyStart = payHdyStart;
    }

    public String[] getPayHdyEnd() {
        return payHdyEnd;
    }

    public void setPayHdyEnd(String[] payHdyEnd) {
        this.payHdyEnd = payHdyEnd;
    }
